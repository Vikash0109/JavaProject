...
public class Home{
	...
	public void homeView(int id) throws SQLException {
		...
		//----------------------STUDENTS----------------------------
		JButton students = new JButton("PATIENTS");
		...
		//----------------------ADDATTENDANCE----------------------------
		JButton addattendance = new JButton("NO OF TIMES PATEINT VISITED");
		...
		//----------------------TEACHERS----------------------------
		JButton teacher = new JButton("DOCTORS");
		...
		//----------------------CLASS----------------------------
		JButton classes = new JButton("WARD");
